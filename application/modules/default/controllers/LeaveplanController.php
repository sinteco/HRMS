...
class Default_LeaveplanController extends Zend_Controller_Action
{
	...
	public function indexAction()
    {
		...
		*/
		...
		/*
		START
		Query to get the number of available annual leaves for the employee 
		*/   
		...
		if($leaverequestform->isValid($this->_request->getPost()) && $errorflag == 'true')
		    {
                ...
                <table width="50%" cellspacing="0" cellpadding="5" border="0" style="border:3px solid #BBBBBB; font-size:12px; font-family:Arial, Helvetica, sans-serif; margin:10px 0 10px 0;" bgcolor="#ffffff">
                      <tbody><tr>
                        <td width="22%" style="border-right:2px solid #BBBBBB;">Employee Name</td>
                        <td width="52%">'.$userfullname.'</td>
                      </tr>
                      <tr bgcolor="#e9f6fc">
					...
					**/
					...
					for($i=1;$i<=3;$i++) {
						...
						if($toEmail!='' && $toName!='') {
							...
							$options['message'] .= '<div>
                			<table width="60%" cellspacing="0" cellpadding="5" border="0" style="border:3px solid #BBBBBB; font-size:12px; font-family:Arial, Helvetica, sans-serif; margin:10px 0 10px 0;" bgcolor="#ffffff">
	                      	<tbody>
		                      <tr>
		                        <td width="18%" style="border-right:2px solid #BBBBBB;">Employee Name</td>
		                        <td width="62%">'.$employeename.'</td>
		                      </tr>
		                      <tr bgcolor="#e9f6fc">
		                        <td style="border-right:2px solid #BBBBBB;">No. of Day(s)</td>
