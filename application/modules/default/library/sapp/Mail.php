...
class sapp_Mail
{
	...
	public static function _email($options = array()) {
		...
		$options['fromName'] = (!empty($options['fromName']))?$options['fromName']:HRMS;
	...
	public static function send_php_mail($config = array(), $smtpserver='', $imgsource='', $options = array())
	{
		...
		<div style="width:80%;">
            ...
            <div style="padding:20px 20px 50px 20px;">
                    <div>
                        <h1 style="font-family:Arial, Helvetica, sans-serif; font-size:13px; font-weight:bold; border-bottom:1px dashed #999; padding-bottom:15px;">'.$options['header'].'</h1>
                    </div>
                    
                    <div style="font-family:Arial, Helvetica, sans-serif; font-size:13px; font-weight:normal; line-height:10px; margin:0 0 20px 0;">
                        '.$options['message'].'
                    </div>
                    
                    <div style="font-family:Arial, Helvetica, sans-serif; font-size:13px; font-weight:normal; line-height:10px;">
                        Regards,<br>
						
		
						<p>Leave management and timesheet system<br>
							IT and HR Team<br>
