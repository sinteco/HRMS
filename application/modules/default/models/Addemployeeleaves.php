	...
	*/
    public function getEmployeesData($sort,$by,$pageNo,$perPage,$searchQuery,$managerid='',$loginUserId)
    {
        ...
        $employeesData = $this->select()
                                ...
                                ->joinLeft(array('el'=>'main_employeeleaves'), 'el.user_id=e.user_id',array('el.used_leaves','ROUND(IF(((DATEDIFF(now(),e.date_of_joining)/30))>=12,20,((DATEDIFF(now(),e.date_of_joining)/30)*(20/12)))+(DATEDIFF(now(),e.date_of_joining)/365.25)-1,2) as emp_leave_limit','ROUND((DATEDIFF(now(),e.date_of_joining)/365.25),2) as serviceyear','IF(el.alloted_year<year(now()),(IF(month(now())<=3, IF((ROUND(((IF(((DATEDIFF(concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "),e.date_of_joining)/30))>=12,20,((DATEDIFF(concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "),e.date_of_joining)/30)*(20/12)))+(DATEDIFF(concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "),e.date_of_joining)/365.25))/12 *12)-1,2)) - el.used_leaves > 10,10,(ROUND(((IF(((DATEDIFF(concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "),e.date_of_joining)/30))>=12,20,((DATEDIFF(concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "),e.date_of_joining)/30)*(20/12)))+(DATEDIFF(concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "),e.date_of_joining)/365.25))/12 * 12)-1,2)) - el.used_leaves), 0)),IF(((DATEDIFF(concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "),e.date_of_joining)/30))>=12,0,(ROUND((IF(((DATEDIFF(now(),e.date_of_joining)/30))>=12,20,((DATEDIFF(now(),e.date_of_joining)/30)*(20/12)))+(DATEDIFF(now(),e.date_of_joining)/365.25))/12 * MONTH(CURRENT_TIMESTAMP)-1,2)))) as transfer','el.createddate','el.isleavetrasnferset','(IF(el.alloted_year<year(now()),(IF(month(now())<=3, IF((ROUND(((IF(((DATEDIFF(concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "),e.date_of_joining)/30))>=12,20,((DATEDIFF(concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "),e.date_of_joining)/30)*(20/12)))+(DATEDIFF(concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "),e.date_of_joining)/365.25))/12 * MONTH(CURRENT_TIMESTAMP))-1,2)) - el.used_leaves > 10,10,(ROUND(((IF(((DATEDIFF(concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "),e.date_of_joining)/30))>=12,20,((DATEDIFF(concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "),e.date_of_joining)/30)*(20/12)))+(DATEDIFF(concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "),e.date_of_joining)/365.25))/12 * MONTH(CURRENT_TIMESTAMP))-1,2)) - el.used_leaves), 0)),0)) + (ROUND((IF(((DATEDIFF(now(),e.date_of_joining)/30))>=12,20,((DATEDIFF(now(),e.date_of_joining)/30)*(20/12)))+(DATEDIFF(now(),e.date_of_joining)/365.25))/12 * MONTH(CURRENT_TIMESTAMP)-1,2)) as totalavailableleave','remainingleaves'=>new Zend_Db_Expr('ROUND(((IF(((DATEDIFF(now(),e.date_of_joining)/30))>=12,20,((DATEDIFF(now(),e.date_of_joining)/30)*(20/12)))+(DATEDIFF(now(),e.date_of_joining)/365.25))/12 * MONTH(CURRENT_TIMESTAMP))-1,2) - el.used_leaves')))                                        
                                ->where($where)
                                ->order("$by $sort") 
