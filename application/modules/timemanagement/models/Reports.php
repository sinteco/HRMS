...
class Timemanagement_Model_Reports extends Zend_Db_Table_Abstract
{
	...
	public function gettsstatusReport($month,$year){
...
//===========================================================================================
	...
	public function getLeaveReportsData($sort, $by, $pageNo, $perPage, $searchQuery,$start_date, $end_date, $projid, $param="",$flag="",$datefrom,$dateto)
	{
        ...
        $employeesData = $this->select()
                                ...
                                ) as transfer','el.createddate','el.isleavetrasnferset','ROUND(ROUND(IF(e.date_of_joining <= concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "),DATEDIFF(now(),concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "))/365.25, DATEDIFF(now(),e.date_of_joining)/365.25)*(20+(ROUND((DATEDIFF(now(),e.date_of_joining)/365.25),2))-1),2) + ROUND(IF((DATEDIFF(concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "),e.date_of_joining)/30)>=12,IF(MONTH(now())>3,0,IF(((DATEDIFF(now(),concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "))/365.25)*(20+(ROUND((DATEDIFF(concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "),e.date_of_joining)/365.25),2))-1))-el.used_leaves<10,10,((DATEDIFF(now(),concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "))/365.25)*(20+(ROUND((DATEDIFF(concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "),e.date_of_joining)/365.25),2))-1))-el.used_leaves)),IF((DATEDIFF(now(),e.date_of_joining)/30)>=12&&MONTH(now())>3,0,IF((ROUND((DATEDIFF(concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "),e.date_of_joining)/365.25)*(20+(ROUND((DATEDIFF(concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "),e.date_of_joining)/365.25),2))-1),2)-el.used_leaves)>0,(ROUND((DATEDIFF(concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "),e.date_of_joining)/365.25)*(20+(ROUND((DATEDIFF(concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "),e.date_of_joining)/365.25),2))-1),2)-el.used_leaves),0))),2),2) as totalavailableleave','remainingleaves'=>new Zend_Db_Expr('ROUND(ROUND(IF(e.date_of_joining <= concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "),DATEDIFF(now(),concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "))/365.25, DATEDIFF(now(),e.date_of_joining)/365.25)*(20+(ROUND((DATEDIFF(now(),e.date_of_joining)/365.25),2))-1),2) + IF((DATEDIFF(concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "),e.date_of_joining)/30)>=12,IF(MONTH(now())>3,0,IF(((DATEDIFF(now(),concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "))/365.25)*(20+(ROUND((DATEDIFF(concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "),e.date_of_joining)/365.25),2))-1))-el.used_leaves<10,10,((DATEDIFF(now(),concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "))/365.25)*(20+(ROUND((DATEDIFF(concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "),e.date_of_joining)/365.25),2))-1))-el.used_leaves)),IF((DATEDIFF(now(),e.date_of_joining)/30)>=12&&MONTH(now())>3,0,IF((ROUND((DATEDIFF(concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "),e.date_of_joining)/365.25)*(20+(ROUND((DATEDIFF(concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "),e.date_of_joining)/365.25),2))-1),2)-el.used_leaves)>0,(ROUND((DATEDIFF(concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "),e.date_of_joining)/365.25)*(20+(ROUND((DATEDIFF(concat(year(now() - INTERVAL 1 YEAR), "-12-31 03:30:48 "),e.date_of_joining)/365.25),2))-1),2)-el.used_leaves),0))) - COALESCE(SUM(IF(lr.leavestatus="Approved" and lr.leavetypeid=15 and lr.from_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE) and lr.to_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE),lr.appliedleavescount,0)),0),2)'),'COALESCE(SUM(IF(lr.leavestatus="Approved" and lr.leavetypeid=15 and lr.from_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE) and lr.to_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE),lr.appliedleavescount,0)),0) as annual_paid_leave','COALESCE(SUM(IF(lr.leavestatus="Approved" and lr.leavetypeid=16 and lr.from_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE) and lr.to_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE),lr.appliedleavescount,0)),0) as unpaid_annual_leave','COALESCE(SUM(IF(lr.leavestatus="Approved" and lr.leavetypeid=1 and lr.from_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE) and lr.to_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE),lr.appliedleavescount,0)),0) as sick_leave','COALESCE(SUM(IF(lr.leavestatus="Approved" and lr.leavetypeid=2 and lr.from_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE) and lr.to_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE),lr.appliedleavescount,0)),0) as maternity_leave','COALESCE(SUM(IF(lr.leavestatus="Approved" and lr.leavetypeid=19 and lr.from_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE) and lr.to_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE),lr.appliedleavescount,0)),0) as compensatory_leave','COALESCE(SUM(IF(lr.leavestatus="Approved" and lr.leavetypeid=30 and lr.from_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE) and lr.to_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE),lr.appliedleavescount,0)),0) as accident_leave','COALESCE(SUM(IF(lr.leavestatus="Approved" and lr.leavetypeid=20 and lr.from_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE) and lr.to_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE),lr.appliedleavescount,0)),0) as miscarriage_leave','COALESCE(SUM(IF(lr.leavestatus="Approved" and lr.leavetypeid=21 and lr.from_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE) and lr.to_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE),lr.appliedleavescount,0)),0) as miscarriagepaternity_leave','COALESCE(SUM(IF(lr.leavestatus="Approved" and lr.leavetypeid=13 and lr.from_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE) and lr.to_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE),lr.appliedleavescount,0)),0) as paternity_leave','COALESCE(SUM(IF(lr.leavestatus="Approved" and lr.leavetypeid=22 and lr.from_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE) and lr.to_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE),lr.appliedleavescount,0)),0) as childnursing_leave','COALESCE(SUM(IF(lr.leavestatus="Approved" and lr.leavetypeid=23 and lr.from_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE) and lr.to_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE),lr.appliedleavescount,0)),0) as pernatalrelated_leave','COALESCE(SUM(IF(lr.leavestatus="Approved" and lr.leavetypeid=24 and lr.from_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE) and lr.to_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE),lr.appliedleavescount,0)),0) as compassionateNIR_leave','COALESCE(SUM(IF(lr.leavestatus="Approved" and lr.leavetypeid=25 and lr.from_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE) and lr.to_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE),lr.appliedleavescount,0)),0) as CompassionateIR_leave','COALESCE(SUM(IF(lr.leavestatus="Approved" and lr.leavetypeid=27 and lr.from_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE) and lr.to_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE),lr.appliedleavescount,0)),0) as variableleavefamily','COALESCE(SUM(IF(lr.leavestatus="Approved" and lr.leavetypeid=14 and lr.from_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE) and lr.to_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE),lr.appliedleavescount,0)),0) as examinationandstudy_leave','COALESCE(SUM(IF(lr.leavestatus="Approved" and lr.leavetypeid=18 and lr.from_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE) and lr.to_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE),lr.appliedleavescount,0)),0) as court_leave','COALESCE(SUM(IF(lr.leavestatus="Approved" and lr.leavetypeid=29 and lr.from_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE) and lr.to_date BETWEEN CAST(CONCAT(YEAR(now()),"'.$datefrom.'") AS DATE) AND CAST(CONCAT(YEAR(now()),"'.$dateto.'") AS DATE),lr.appliedleavescount,0)),0) as emergencyunpaid_leave'))                                        
...
//==============Add header on the employee timesheet header==============================================	
  ...
  public function tmsheetstatusReportHeader()
  {
